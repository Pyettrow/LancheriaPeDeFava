...
public class DAO<T> {
     ...
     * do pedido passado Classe - Enviar a classe para realizar a
     * constula(Pedido.class) Pedido - Passar o numero do pedido para realizar a
     * consulta, caso não precisa passar 0
     *
     * @param classe
     * @param pedido
     * @return
     ...
     * seja igual a null seria retornado o valor 1 para primeiro cadastro.
     * Recebe a classe que dever ser realizado a consulta retorna um int com o
     * valor
     *
     * @param classe
     * @return
     ...
     * para apagar um produto no local do OBJ é necessário passar o id do
     * produto
     *
     * @param opcao
     * @param obj
    ...
    /**
     * Metodo para realizar a consulta com base no objeto que foi passado tentei
     * fazer de modo generico, porém estou com dúvidas no tipo de variavel que
     * tenho que retornar, coloquei "Produto" para quebrar o galho
     *
     * @param codProd
     * @return
     * @throws SQLException
    ...
    /**
     * Será usado no Bot, serve para verificar se o cliente existe atravez de um
     * select realizado com o where do ID do cliente(ID = id do telegran)
     *
     * @param idTelegran
     * @return
     * @throws SQLException
    ...
    /**
     * Consultas no geral, não estava achando um metodo que iria caber para
     * essas consultas. Com opção 1 irá realizara consulta no pedidoItem para
     * retornar o preço total de um pedido especifico. cod1: Serve para validar
     * nos IF's qual consulta seria realizada cod1 = 1(Select que retornar o
     * preço total de um pedido) cod1 = 2(Ira alterar o pedido para entregue =
     * 1) cod2 - Manda a PK para poder fazer a operação necessária
     *
     * @param cod1
     * @param cod2
     */
